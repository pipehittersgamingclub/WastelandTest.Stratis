...
_serverInfoString = format ["<t color='#A0FFFFFF'>Pipehitters Wasteland #%1 %2</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://www.pipehitters.us'>Pipehitters</a></t> Forums: <t color='#0091CD'><a href='http://www.pipehitters.us/forums'>Pipehitters Forums</a></t> TeamSpeak: ts.pipehitters.us";
